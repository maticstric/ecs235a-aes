...
ISBOX = [
    ...
    0x3a, 0x91, 0x11, 0x41, 0x4f, 0x67, 0xdc, 0xea, 0x90, 0xf2, 0xcf, 0xce, 0xf0, 0xb4, 0xe6, 0x73,
    0x96, 0xac, 0x74, 0x22, 0xe7, 0xad, 0x35, 0x85, 0xe2, 0xf9, 0x37, 0xe8, 0x1c, 0x70, 0xdf, 0x6e,
...
MESSAGE_ARRAY = [0x32, 0x88, 0x31, 0xe0, 0x43, 0x5a, 0x31, 0x37, 0xf6, 0x30, 0x98, 0x07, 0xa8, 0x8d, 0xa2, 0x34]
...
def combine_blocks_into_message_array(blocks):
    ...
    for i in range(len(blocks)):
        ...
        for j in range(4):
            for k in range(4):
                message_array.append(block[j][k])
